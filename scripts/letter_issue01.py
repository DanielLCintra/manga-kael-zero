...
LETTERING: dict[int, list[dict]] = {
    ...
    7: [
        # rua → casa → post-it → resposta (nunca responder antes de ler o bilhete)
        {
    ...
    11: [
        # splash lab | porta+skate | envelope | ajoelha com prova
        {
            "text": "…pai?",
            "kind": "speech",
            "panel": P(0.02, 0.28, 0.49, 0.52),
            "speaker": (0.28, 0.42),
            "slot": 0,
            "pos": (0.62, 0.14),
        },
    ...
    13: [
        # 01/12 | hesita | AUTH | dois dedos no vidro (sem sangue)
        {
            "text": "Um de doze.\nSério, pai?",
            "kind": "speech",
            "panel": P(0.02, 0.01, 0.98, 0.24),
            "speaker": (0.55, 0.18),
            "slot": 0,
            "pos": (0.78, 0.22),
        },
    ...
    18: [
        # mesma noite: quarto + HUD residual (sozinho)
        {"text": "MESMA NOITE", "kind": "caption", "panel": P(0.02, 0.02, 0.40, 0.12), "slot": 0},
        {
            "text": "Ainda tá aí?",
            "kind": "speech",
            "panel": P(0.02, 0.24, 0.98, 0.48),
            "speaker": (0.42, 0.38),
            "slot": 0,
            "pos": (0.78, 0.14),
        },
    ...
    20: [
        # Painéis apertados: 1 balão por painel no topo (evita QC de chapéu/overlap)
        {
        ...
        {
            "text": "Desculpa. Tô aqui. Continua.\nDormi três horas. Me julga depois.",
            "kind": "speech",
